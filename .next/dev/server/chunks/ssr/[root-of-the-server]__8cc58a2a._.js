...
const metadata = {
    title: 'ASL DevTeam',
    description: 'A youth-driven development team shaping impactful technology for communities and organizations. We deliver web apps, mobile solutions, AI automation, and more.',
    generator: 'Next.js',
    icons: {
        icon: [
            {
